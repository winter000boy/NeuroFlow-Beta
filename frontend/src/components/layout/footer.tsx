      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/employer/dashboard" className="text-muted-foreground hover:text-foreground transition-colors">
                  Employer Dashboard
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/employer/register" className="text-muted-foreground hover:text-foreground transition-colors">
                  Employer Sign Up
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-8 pt-8 border-t">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-sm text-muted-foreground">
              © 2024 JobApp. All rights reserved.
            </p>
